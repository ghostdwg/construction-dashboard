...
INSERT INTO "new_SubmittalItem" ("approvedAt", "bidId", "bidTradeId", "createdAt", "description", "id", "notes", "receivedAt", "requestedAt", "requiredBy", "responsibleSubId", "reviewedAt", "reviewer", "specSectionId", "status", "submittalNumber", "title", "type", "updatedAt") SELECT "approvedAt", "bidId", "bidTradeId", "createdAt", "description", "id", "notes", "receivedAt", "requestedAt", "requiredBy", "responsibleSubId", "reviewedAt", "reviewer", "specSectionId", "status", "submittalNumber", "title", "type", "updatedAt" FROM "SubmittalItem";
