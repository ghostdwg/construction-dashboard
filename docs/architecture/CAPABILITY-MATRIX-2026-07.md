...
- Models: `SubmittalItem` `prisma/schema.prisma:776` (`specSectionId` :786, `source` :797 default `"manual"`, six known values documented inline :788-796 — `manual | regex_seed | ai_extraction | csi_baseline | ai_organized | drawing_analysis`; `sourceJobId` :824, schedule-tie fields :828-835); `SubmittalPackage` :720; `SubmittalDistributionTemplate` :850; module header comment :707-709.
