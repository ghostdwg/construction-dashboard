import { meetingIntelligenceServiceStatus } from "@/lib/services/meetingIntelligence/service";
import { retryMeetingIntelligence } from "@/lib/services/meetingIntelligence/workerJobService";
...
export async function POST(
  ...
  const result = await retryMeetingIntelligence(
    ctx.bidId,
    ctx.meetingId,
    artifactId,
    ctx.actor,
