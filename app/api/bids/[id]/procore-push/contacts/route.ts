// POST /api/bids/[id]/procore-push/contacts
//
// Tier F F2 — Push project team contacts to Procore Company Directory.
// Skips contacts with emails already in Procore.
//
// Response: { ok: true, created, updated, skipped, errors }

import { prisma } from "@/lib/prisma";
import { pushContacts } from "@/lib/services/procore/pushService";
...
export async function POST(
  ...
  try {
    const result = await pushContacts(bidId);
